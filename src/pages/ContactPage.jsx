...
const EMAILJS_PUBLIC_KEY = "pnt8rbEFplKw7tstC";
...
const contactEmailHref = `https://mail.google.com/mail/?view=cm&fs=1&to=${encodeURIComponent(
  contactEmail,
)}&su=${encodeURIComponent("Inquiry from Binazy website")}&body=${encodeURIComponent(
              ...
              >
                ...
                <div>
                  ...
                  <input
                    ...
                    aria-required="true"
                    className={`${fieldClassName} ${errors.fullName ? "border-red-400" : "border-gray-200"}`}
                    {...register("fullName", {
                ...
                <div>
                  ...
                  <input
                    ...
                    aria-required="true"
                    className={`${fieldClassName} ${errors.email ? "border-red-400" : "border-gray-200"}`}
                    {...register("email", {
                ...
                <div>
                  ...
                  <input
                    ...
                    aria-required="true"
                    className={`${fieldClassName} ${errors.phone ? "border-red-400" : "border-gray-200"}`}
                    {...register("phone", {
                ...
                <div>
                  ...
                  <textarea
                    ...
                    aria-required="true"
                    className={`${fieldClassName} resize-none ${errors.message ? "border-red-400" : "border-gray-200"}`}
                    {...register("message", {
